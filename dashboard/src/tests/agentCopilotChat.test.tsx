...
const metadata = (id = 'saved-a', agent = 'demo'): chat.CopilotConversation => ({ id, agent, account_id: 'account-1', model: 'saved-model', permission_mode: 'plan', reasoning_effort: null, delegation_enabled: false, title: `${id} title`, state: 'closed', revision: 9, created_at: 1, updated_at: 2, can_resume: true, reason: '' })
beforeEach(() => {
