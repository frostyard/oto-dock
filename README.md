...
GitHub accounts, with account model discovery, agent chat navigation, saved
conversations, and explicit clean resume. Full engine parity remains incomplete. Use the
